...
<body>
    <div class="main">
        ...
        <div class="main-two">
            ...
            <br>
            <h1 class="admin-h1">Manage Marksheet</h1>
            <div class="manage-class">
                <div class="class-head">
                    <a href=""> Marksheet List</a>
                    ...
                    <button style="margin-left: 20px;" class="btn">
                        <select
                            ...
                            <option style="border: none;" value="">Random Type</option>
                            <option style="border: none;" value="">End Of Term</option>
                            <option style="border: none;" value="">BOT</option>
                            <option style="border: none;" value="">MDT</option>
                        </select>
                    </button>
                    ...
                    <button style="margin-left: 20px;" class="btn">
                        <select
                            style="border: none; outline: none; width:70px; height:15px;  background-color: #21a9e1;">
                            <option style="border: none;" value="">Subject</option>
                            <option style="border: none;" value="">Math</option>
                            <option style="border: none;" value="">Eng</option>
                            <option style="border: none;" value="">ICT
                            <option>
                        </select>
                    </button>
                    ...
                    <button style="margin-left: 20px;" class="btn">
                        <select
                            style="border: none; outline: none; width:70px; height:15px;  background-color: #21a9e1;">
                            <option style="border: none;" value="">Class</option>
                            <option style="border: none;" value="">Form 1</option>
                            <option style="border: none;" value="">S 2</option>
                            <option style="border: none;" value="">S 3
                            <option>
                        </select>
                    </button>
